...
|2021/7/15|楢崎なゆ|第二版|ユースケース記述を追加|
|2021/7/20|楢崎なゆ|第三版|データベース設計書を変更|
|2021/7/25|楢崎なゆ|第四版|ユースケース記述を変更|
|2021/7/31|楢崎なゆ|第五版|クラス図，データベースの定義データ，感想について追加|
...
|name|名前|not null<br>unique<br>varchar 20|-
|users_id|登録するユーザーのid|not null|外部キー

### 5. クラス図
クラス図についてはこのプロジェクトの
table_tennis/docs/test.puml
に記述しています<br>
また，上記のビジュアル表現についてはこのプロジェクトの
table_tennis/docs/uml.png
に記述しています


### 6.データベースの定義データ
データベースの定義データについてはこのプロジェクトの
table_tennis/docs/dif.sql
に記述しています

### 7.課題を終えての感想
課題を終えた感想についてはこのプロジェクトの
table_tennis/docs/report.txt
に記述しています